...
font = pygame.font.Font('../../Downloads/snake-ai-pytorch-main/snake-ai-pytorch-main/arial.ttf', 25)
...
class SnakeGame:
    ...
    def play_step(self):
        ...
        Returns:
            tuple: A tuple containing game over flag and current score.
        """
        # Collect user input
    ...
    def _move(self, direction):
        ...
        Parameters:
            direction (Direction): Direction in which the snake should move.
        """
        x = self.head.x
        y = self.head.y
